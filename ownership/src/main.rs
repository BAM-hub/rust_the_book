fn main() {
    ...
    let deep_copied_string = copied_string.clone();

    // println!("{}", original_string); // error: value borrowed here after move
    println!("{}", copied_string);
    print!("{}", deep_copied_string);
